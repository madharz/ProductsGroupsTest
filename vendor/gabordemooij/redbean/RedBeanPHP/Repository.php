...
abstract class Repository
{
	 ...
	 * This groups of beans has been deleted from a shared list.
	...
	/**
	 * Stores all the beans in the residue groups.
	 * This bean processor processes the beans in the shared residue
	 * groups. This groups of beans 'remains' in the list but might need
